...
class _CommunityServiceScreenState extends State<CommunityServiceScreen> {
  ...
  FirebaseDatabase.instance.ref().child('StudentData').child('studentCommunityEventOrganized');
  final DatabaseReference _studentCommunity =
  FirebaseDatabase.instance.ref().child('StudentData').child('studentCommunityEventParticipation');
