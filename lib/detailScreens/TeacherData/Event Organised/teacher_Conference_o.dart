...
class TeacherConferenceOList extends StatefulWidget {
  @override
  _TeacherConferenceOListState createState() => _TeacherConferenceOListState();
}

class _TeacherConferenceOListState extends State<TeacherConferenceOList> {
  ...
  void initState() {
    super.initState();
    _membersRef = FirebaseDatabase.instance.ref().child('TeacherData/EventOrganised/ConferenceOrganized/id');
    fetchStudents();
  }
  ...
  void _showDetailsDialog(StudentCourse student) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Conference Organised Details'),
          content: Column(
                      ...
                      DropdownButton<String>(
                        ...
                        onChanged: (String? newValue) {
                          setState(() {
                            ...
                            filteredStudents = students
                                .where((student) => student.starting.contains(_selectedYear))
                                .toList();
                          });
                        },
                      ),
