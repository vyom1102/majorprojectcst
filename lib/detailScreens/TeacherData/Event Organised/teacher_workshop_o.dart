...
class TeacherWorkshopOList extends StatefulWidget {
  @override
  _TeacherWorkshopOListState createState() => _TeacherWorkshopOListState();
}

class _TeacherWorkshopOListState extends State<TeacherWorkshopOList> {
  ...
  void initState() {
    super.initState();
    _membersRef = FirebaseDatabase.instance.ref().child('TeacherData/EventOrganised/WorkshopOrganized/id');
    fetchStudents();
  }
  ...
  void _showDetailsDialog(StudentCourse student) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Workshop Organised Details'),
          content: Column(
