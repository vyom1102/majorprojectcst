...
class StudentCulEventParticipationList extends StatefulWidget {
  @override
  _StudentCulEventParticipationListState createState() =>
      _StudentCulEventParticipationListState();
}

class _StudentCulEventParticipationListState
    extends State<StudentCulEventParticipationList> {
  final DatabaseReference _membersRef = FirebaseDatabase.instance
      .ref()
      .child(
      'StudentData/Co-CurricularData/CulturalSocietyData/studentCultureEventParticipation/id');
