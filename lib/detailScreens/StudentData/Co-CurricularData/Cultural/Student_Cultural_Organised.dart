...
class StudentCulEventOrganisedList extends StatefulWidget {
  @override
  _StudentCulEventOrganisedListState createState() =>
      _StudentCulEventOrganisedListState();
}

class _StudentCulEventOrganisedListState
    extends State<StudentCulEventOrganisedList> {
  final DatabaseReference _membersRef = FirebaseDatabase.instance
      .ref()
      .child(
      'StudentData/Co-CurricularData/CulturalSocietyData/studentCultureEventOrganized/id');
