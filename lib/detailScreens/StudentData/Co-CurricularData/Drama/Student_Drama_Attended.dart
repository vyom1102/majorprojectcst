...
class StudentDramaEventParticipationList extends StatefulWidget {
  @override
  _StudentDramaEventParticipationListState createState() =>
      _StudentDramaEventParticipationListState();
}

class _StudentDramaEventParticipationListState
    extends State<StudentDramaEventParticipationList> {
  final DatabaseReference _membersRef = FirebaseDatabase.instance
      .ref()
      .child(
      'StudentData/Co-CurricularData/DramaSocietyData/studentDramaEventParticipation/id');
