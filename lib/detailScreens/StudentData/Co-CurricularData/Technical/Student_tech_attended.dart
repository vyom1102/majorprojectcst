...
class StudentTechEventParticipation {
  final String id;
...
class StudentTechEventParticipationList extends StatefulWidget {
  @override
  _StudentTechEventParticipationListState createState() =>
      _StudentTechEventParticipationListState();
}

class _StudentTechEventParticipationListState
    extends State<StudentTechEventParticipationList> {
  final DatabaseReference _membersRef = FirebaseDatabase.instance
      .ref()
      .child(
      'StudentData/Co-CurricularData/TechnicalSocietyData/studentTechnicalEventParticipation/id');
  List<StudentTechEventParticipation> students = [];
  List<StudentTechEventParticipation> filteredStudents = [];
  ...
  Future<void> fetchStudents() async {
    try {
      _membersRef.onValue.listen((event) {
        ...
        if (data != null) {
          final List<StudentTechEventParticipation> fetchedStudents = [];
          data.forEach((key, value) {
            fetchedStudents.add(StudentTechEventParticipation(
              id: key.toString(),
  ...
  void _showDetailsDialog(StudentTechEventParticipation student) {
    showDialog(
      context: context,
