...
class StudentCommEventParticipationList extends StatefulWidget {
  @override
  _StudentCommEventParticipationListState createState() =>
      _StudentCommEventParticipationListState();
}

class _StudentCommEventParticipationListState
    extends State<StudentCommEventParticipationList> {
  final DatabaseReference _membersRef = FirebaseDatabase.instance
      .ref()
      .child(
      'StudentData/Co-CurricularData/CommunityData/studentCommunityEventParticipation/id');
