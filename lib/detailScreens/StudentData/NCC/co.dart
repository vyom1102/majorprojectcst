...
class StudentCOStudiesList extends StatefulWidget {
  @override
  _StudentCOStudiesListState createState() => _StudentCOStudiesListState();
}

class _StudentCOStudiesListState extends State<StudentCOStudiesList> {
  ...
  void initState() {
    super.initState();
    _membersRef = FirebaseDatabase.instance.ref().child('StudentData/NCCNSS/CO/id');
    fetchStudents();
  }
