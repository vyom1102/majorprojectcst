...
class StudentmaleStudiesList extends StatefulWidget {
  @override
  _StudentmaleStudiesListState createState() => _StudentmaleStudiesListState();
}

class _StudentmaleStudiesListState extends State<StudentmaleStudiesList> {
  ...
  void initState() {
    super.initState();
    _membersRef = FirebaseDatabase.instance.ref().child('StudentData/NCCNSS/Male/id');
    fetchStudents();
  }
